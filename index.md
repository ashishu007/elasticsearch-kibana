...
On the top-left corner, click the three parallel lines (<span class="math">&#8801</span>) to open the menu. Now scroll-down to find the `Dev Tools` option under `Management` section. Click it to go to the console where we will be writing the queries.
